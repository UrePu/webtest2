...
$(document).ready(function() {  // 문서 열리면 해당 코드가 실행
	//////////////////////////////////////아이디 체크//////////////////////////////////////////////////////
	$("#mid").keyup( function(){ 
		...
		console.log(1);
		let idj = /^[a-zA-Z0-9]{4,10}$/;
		if( idj.test( mid ) ){ 
			idcheck.innerHTML="사용가능한 아이디 입니다.";  pass[0] = true;
		}else{
			idcheck.innerHTML = "영소문자 4~10 사이로 입력해주세요!"; pass[0] = false;
		}
	}); // keyup end 
	//////////////////////////////////////아이디 체크 end //////////////////////////////////////////////////////
	...
	$("#mpassword").keyup( function(){  // 비밀번호 입력할때마다
		...
		let passswordj = /^[a-zA-Z0-9]{12,16}$/; // 정규표현식
		...
		if( passswordj.test( mpassword ) ){ // 정규표현식 같으면
			...
			$("#passwordcheck").html("영소문자 12~16 사이로 입력해주세요!"); pass[1] = false;
		}
	}); // keyup end 
	...
	$("#mpasswordcheck").keyup( function(){  // 비밀번호 입력할때마다
		...
		if( passswordj.test( mpasswordcheck ) ){ // 정규표현식 같으면
			...
			$("#passwordcheck").html("영소문자 12~16 사이로 입력해주세요!"); pass[2] = false;
		}
	}); // keyup end 
